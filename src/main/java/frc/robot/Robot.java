...
public class Robot extends HuskyRobot {
  ...
  private PneumaticsTestTeleopDecisionMaker m_TeleopDecider = new PneumaticsTestTeleopDecisionMaker();
  private PneumaticsTestAutonomousDecisionMaker m_AutoDecider = new PneumaticsTestAutonomousDecisionMaker();
