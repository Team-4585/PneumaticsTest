...
public class PneumaticsTestJoystick extends HuskyJoystick{
  private static final int PneumaticsTest_JOYSTICK_PORT = 0;
  ...
  public PneumaticsTestJoystick(){
      super(PneumaticsTest_JOYSTICK_PORT);
  }
